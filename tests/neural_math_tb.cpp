...
int sc_main (int argc, char* argv[]) {
    ...
    inputs[2].write(0.999224345493303f);
    inputs[3].write(0.9992826834871f);

    weights[0].write(-4.0961078688499155f);
    weights[1].write(-14.892351723504802f);
    weights[2].write(-8.589540987991482f);
    weights[3].write(-9.79067155131993f);
    sc_start(10, SC_NS);
    enable = 1;
    inputs[0].write(0.9991566901389833f);
    inputs[1].write(0.9999998737712528f);
    inputs[2].write(0.9259701252780933f);
    inputs[3].write(0.9993096918528903f);

    weights[0].write(6.262679709682974f);
    weights[1].write(45.32539856128967f);
    weights[2].write(6.072379717196129f);
